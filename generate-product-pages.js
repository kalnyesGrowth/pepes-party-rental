...
function buildSeoTitle(product) {
  ...
  return `${product.name} Rental | Stafford, VA | Pepe's Party Rental`;
}
...
function buildMetaDesc(product) {
  ...
  return `Rent ${namePrefix}${product.name} in Stafford, VA. Starting at ${price}. Free delivery, setup & takedown. No deposit required. 13+ years, 4.7 stars. Book online today!`;
}
...
function buildSchemaOrg(product) {
  const schema = {
    ...
    "offers": {
      ...
      "url": `https://pepespartyrentall.com/products/${product.handle}`,
      "seller": {
        "@type": "LocalBusiness",
        "name": "Pepe's Party Rental",
        "address": {
          "@type": "PostalAddress",
          "streetAddress": "94 Tacketts Mill Rd",
...
function buildLocalBusinessSchema() {
  return JSON.stringify({
    ...
    "url": "https://pepespartyrentall.com",
...
<link rel="canonical" href="https://pepespartyrentall.com/products/${product.handle}">
<meta property="og:title" content="${esc(product.name)} Rental | Pepe's Party Rental">
...
<meta property="og:url" content="https://pepespartyrentall.com/products/${product.handle}">
    ...
    <div class="product-grid">
      ...
      <div class="product-info">
        ...
        <div class="product-rating">
          ...
          <span class="product-rating-text">4.7 (118+ reviews)</span>
        </div>
...
<footer class="footer">
  <div class="container">
    ...
    <div class="footer-bottom">
      <p>&copy; ${new Date().getFullYear()} Pepe's Party Rental. All rights reserved. | 94 Tacketts Mill Rd, Stafford, VA 22556</p>
    </div>
  </div>
</footer>
